...
function OnLoadNewsListClick(pageindex, par) {
    $.ajax({
        url: "Handler/WebSite.ashx?action=NewListxian",
        ...
        success: function (json) {
            ...
            if (null != json) {
                ...
                $.each(productData, function (i, n) {
                    news += " <li><span>" + n.CreateDate + "</span><a target=\"_blank\" href=\"NewsDetails.aspx?t=" + n.NewsTypeId + "&id=" + n.Id + "\">" + n.NewsTitle + "</a></li>";
                    if (i % 5 == 0 && i != 0) {
