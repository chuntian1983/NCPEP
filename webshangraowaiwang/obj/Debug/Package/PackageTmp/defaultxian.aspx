<%@ Page Title="" Language="C#" MasterPageFile="~/Site2xian.Master" AutoEventWireup="true" CodeBehind="defaultxian.aspx.cs" Inherits="Web.defaultxian" %>
...
<link href="Super/Scripts/easyUI/themes/icon.css" rel="stylesheet" type="text/css" />
    <script src="Scripts/Defaultxian.js" type="text/javascript" language="javascript"></script>
...
<input id="hdcode" type="hidden" runat="server" />
    </form>
</asp:Content>
