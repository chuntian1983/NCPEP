...
namespace NCPEP.Bll
{
    ...
    {
        private readonly NCPEP.Dal.T_Bid dal = new NCPEP.Dal.T_Bid();
        public T_Bid()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 获得数据列表
        /// </summary>
        public List<NCPEP.Model.T_Bid> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<NCPEP.Model.T_Bid> DataTableToList(DataTable dt)
        {
            List<NCPEP.Model.T_Bid> modelList = new List<NCPEP.Model.T_Bid>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                NCPEP.Model.T_Bid model;
