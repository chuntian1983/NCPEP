<%@ Page Title="" Language="C#" MasterPageFile="~/Sitexian.Master" AutoEventWireup="true" CodeBehind="NewsListxian.aspx.cs" Inherits="Web.NewsListxian" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="Scripts/NewsList.js" type="text/javascript" language="javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="list_wz top">
        位置：<a href="Default.aspx">首页</a> >> <span id="lbl_List_NewsTypeName"></span>
    </div>
    <div class="list top">
        <span id="lblNewsList"></span>
        <div>
