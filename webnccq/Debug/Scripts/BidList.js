        ...
        success: function (json) {
            ...
            if (null != json) {
                ...
                $.each(productData, function (i, n) {
                    tbidList += "<tr><td class=\"th3\">HJNS" + n.Admissibility + "</td><td class=\"th2\"><a href=\"BidDetails.aspx?t=" + n.FK_LiceTranId + "&id=" + n.Id + "\">" + n.BidName + "</a></td><td class=\"th1\">" + n.Properties + "</td><td class=\"th1\">" + n.StartDate.substring(0, 10) + "</td><td class=\"th1\">" + n.ListingPrice + "</td><td class=\"th1\">" + n.EndDate.substring(0, 10) + "</td><td class=\"th1\"><a href=\"\"><!--<img src=\"images/nc_30.jpg\">--></a></td></tr>";
                });
