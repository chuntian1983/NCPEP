<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiceOrTran.aspx.cs" Inherits="Web.Super.Lt.LiceOrTran" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/LiceOrTran.js" type="text/javascript" language="javascript"></script>
    <style type="text/css">
        .divhide
        {
            display: none;
